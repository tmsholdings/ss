...
$sql_create_table[] = 'INSERT INTO ' . NV_CONFIG_GLOBALTABLE . ' (lang, module, config_name, config_value) VALUES (\'sys\', \'site\', \'nv_csp\', \'{"default-src":{"self":1},"script-src":{"self":1,"unsafe-inline":1,"unsafe-eval":1,"hosts":["*.google.com","*.google-analytics.com","*.googletagmanager.com","*.gstatic.com","*.facebook.com","*.facebook.net","*.twitter.com","*.zalo.me","*.zaloapp.com","*.tawk.to","*.cloudflareinsights.com"]},"style-src":{"self":1,"data":1,"unsafe-inline":1,"hosts":["*.google.com","*.googleapis.com","*.tawk.to"]},"img-src":{"self":1,"data":1,"hosts":["*.twitter.com","*.google.com","*.googleapis.com","*.google-analytics.com","*.gstatic.com","*.facebook.com","tawk.link","*.tawk.to","static.tms.vn"]},"font-src":{"self":1,"data":1,"hosts":["*.googleapis.com","*.gstatic.com","*.tawk.to"]},"connect-src":{"self":1,"hosts":["*.google-analytics.com","*.zalo.me","*.tawk.to","wss:\/\/*.tawk.to"]},"media-src":{"self":1,"hosts":["*.tawk.to"]},"frame-src":{"self":1,"hosts":["*.google.com","*.youtube.com","*.facebook.com","*.facebook.net","*.twitter.com","*.zalo.me"]},"form-action":{"self":1,"hosts":["*.google.com"]}}\')';
...
$sql_create_table[] = 'INSERT INTO ' . $db_config['prefix'] . "_setup_extensions (id, type, title, is_sys, is_virtual, basename, table_prefix, version, addtime, author, note) VALUES (0, 'module', 'about', 0, 0, 'page', 'about', '4.5.00 1626512400', " . NV_CURRENTTIME . ", 'VINADES <contact@tms.vn>', '')";
$sql_create_table[] = 'INSERT INTO ' . $db_config['prefix'] . "_setup_extensions (id, type, title, is_sys, is_virtual, basename, table_prefix, version, addtime, author, note) VALUES (0, 'module', 'siteterms', 0, 0, 'page', 'siteterms', '4.5.00 1626512400', " . NV_CURRENTTIME . ", 'VINADES <contact@tms.vn>', '')";
$sql_create_table[] = 'INSERT INTO ' . $db_config['prefix'] . "_setup_extensions (id, type, title, is_sys, is_virtual, basename, table_prefix, version, addtime, author, note) VALUES (19, 'module', 'banners', 1, 0, 'banners', 'banners', '4.5.00 1626512400', " . NV_CURRENTTIME . ", 'VINADES <contact@tms.vn>', '')";
$sql_create_table[] = 'INSERT INTO ' . $db_config['prefix'] . "_setup_extensions (id, type, title, is_sys, is_virtual, basename, table_prefix, version, addtime, author, note) VALUES (0, 'module', 'zalo', 1, 0, 'zalo', 'zalo', '4.6.00 1637048941', " . NV_CURRENTTIME . ", 'VINADES <contact@tms.vn>', '')";
$sql_create_table[] = 'INSERT INTO ' . $db_config['prefix'] . "_setup_extensions (id, type, title, is_sys, is_virtual, basename, table_prefix, version, addtime, author, note) VALUES (20, 'module', 'contact', 0, 1, 'contact', 'contact', '4.5.00 1626512400', " . NV_CURRENTTIME . ", 'VINADES <contact@tms.vn>', '')";
$sql_create_table[] = 'INSERT INTO ' . $db_config['prefix'] . "_setup_extensions (id, type, title, is_sys, is_virtual, basename, table_prefix, version, addtime, author, note) VALUES (1, 'module', 'news', 0, 1, 'news', 'news', '4.5.00 1626512400', " . NV_CURRENTTIME . ", 'VINADES <contact@tms.vn>', '')";
$sql_create_table[] = 'INSERT INTO ' . $db_config['prefix'] . "_setup_extensions (id, type, title, is_sys, is_virtual, basename, table_prefix, version, addtime, author, note) VALUES (21, 'module', 'voting', 0, 0, 'voting', 'voting', '4.5.00 1626512400', " . NV_CURRENTTIME . ", 'VINADES <contact@tms.vn>', '')";
$sql_create_table[] = 'INSERT INTO ' . $db_config['prefix'] . "_setup_extensions (id, type, title, is_sys, is_virtual, basename, table_prefix, version, addtime, author, note) VALUES (22, 'module', 'forum', 0, 0, 'forum', 'forum', '4.5.00 1626512400', " . NV_CURRENTTIME . ", 'VINADES <contact@tms.vn>', '')";
$sql_create_table[] = 'INSERT INTO ' . $db_config['prefix'] . "_setup_extensions (id, type, title, is_sys, is_virtual, basename, table_prefix, version, addtime, author, note) VALUES (284, 'module', 'seek', 1, 0, 'seek', 'seek', '4.5.00 1626512400', " . NV_CURRENTTIME . ", 'VINADES <contact@tms.vn>', '')";
$sql_create_table[] = 'INSERT INTO ' . $db_config['prefix'] . "_setup_extensions (id, type, title, is_sys, is_virtual, basename, table_prefix, version, addtime, author, note) VALUES (24, 'module', 'users', 1, 1, 'users', 'users', '4.5.00 1626512400', " . NV_CURRENTTIME . ", 'VINADES <contact@tms.vn>', '')";
$sql_create_table[] = 'INSERT INTO ' . $db_config['prefix'] . "_setup_extensions (id, type, title, is_sys, is_virtual, basename, table_prefix, version, addtime, author, note) VALUES (27, 'module', 'statistics', 0, 0, 'statistics', 'statistics', '4.5.00 1626512400', " . NV_CURRENTTIME . ", 'VINADES <contact@tms.vn>', '')";
$sql_create_table[] = 'INSERT INTO ' . $db_config['prefix'] . "_setup_extensions (id, type, title, is_sys, is_virtual, basename, table_prefix, version, addtime, author, note) VALUES (29, 'module', 'menu', 0, 0, 'menu', 'menu', '4.5.00 1626512400', " . NV_CURRENTTIME . ", 'VINADES <contact@tms.vn>', '')";
$sql_create_table[] = 'INSERT INTO ' . $db_config['prefix'] . "_setup_extensions (id, type, title, is_sys, is_virtual, basename, table_prefix, version, addtime, author, note) VALUES (283, 'module', 'feeds', 1, 0, 'feeds', 'feeds', '4.5.00 1626512400', " . NV_CURRENTTIME . ", 'VINADES <contact@tms.vn>', '')";
$sql_create_table[] = 'INSERT INTO ' . $db_config['prefix'] . "_setup_extensions (id, type, title, is_sys, is_virtual, basename, table_prefix, version, addtime, author, note) VALUES (282, 'module', 'page', 1, 1, 'page', 'page', '4.5.00 1626512400', " . NV_CURRENTTIME . ", 'VINADES <contact@tms.vn>', '')";
$sql_create_table[] = 'INSERT INTO ' . $db_config['prefix'] . "_setup_extensions (id, type, title, is_sys, is_virtual, basename, table_prefix, version, addtime, author, note) VALUES (281, 'module', 'comment', 1, 0, 'comment', 'comment', '4.5.00 1626512400', " . NV_CURRENTTIME . ", 'VINADES <contact@tms.vn>', '')";
$sql_create_table[] = 'INSERT INTO ' . $db_config['prefix'] . "_setup_extensions (id, type, title, is_sys, is_virtual, basename, table_prefix, version, addtime, author, note) VALUES (312, 'module', 'freecontent', 0, 1, 'freecontent', 'freecontent', '4.5.00 1626512400', " . NV_CURRENTTIME . ", 'VINADES <contact@tms.vn>', '')";
$sql_create_table[] = 'INSERT INTO ' . $db_config['prefix'] . "_setup_extensions (id, type, title, is_sys, is_virtual, basename, table_prefix, version, addtime, author, note) VALUES (327, 'module', 'two-step-verification', 1, 0, 'two-step-verification', 'two_step_verification', '4.5.00 1626512400', " . NV_CURRENTTIME . ", 'VINADES <contact@tms.vn>', '')";
$sql_create_table[] = 'INSERT INTO ' . $db_config['prefix'] . "_setup_extensions (id, type, title, is_sys, is_virtual, basename, table_prefix, version, addtime, author, note) VALUES (307, 'theme', 'default', 0, 0, 'default', 'default', '4.5.00 1626512400', " . NV_CURRENTTIME . ", 'VINADES <contact@tms.vn>', '')";
$sql_create_table[] = 'INSERT INTO ' . $db_config['prefix'] . "_setup_extensions (id, type, title, is_sys, is_virtual, basename, table_prefix, version, addtime, author, note) VALUES (311, 'theme', 'mobile_default', 0, 0, 'mobile_default', 'mobile_default', '4.5.00 1626512400', " . NV_CURRENTTIME . ", 'VINADES <contact@tms.vn>', '')";
