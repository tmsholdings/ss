...
//Document
$array_url_instruction['main'] = 'https://wiki.tms.vn/nukeviet4:admin:users#quản_trị';
$array_url_instruction['add'] = 'https://wiki.tms.vn/nukeviet4:admin:users#them_quản_trị';
$array_url_instruction['module'] = 'https://wiki.tms.vn/nukeviet4:admin:users#quyền_hạn_quản_ly_module';
$array_url_instruction['config'] = 'https://wiki.tms.vn/nukeviet4:admin:users#cấu_hinh';
