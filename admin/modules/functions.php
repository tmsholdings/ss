...
// Document
$array_url_instruction['main'] = 'https://wiki.tms.vn/nukeviet4:admin:modules:modules';
$array_url_instruction['setup'] = 'https://wiki.tms.vn/nukeviet4:admin:modules:setup';
$array_url_instruction['vmodule'] = 'https://wiki.tms.vn/nukeviet4:admin:modules:vmodule';
$array_url_instruction['edit'] = 'https://wiki.tms.vn/nukeviet4:admin:modules:edit';
