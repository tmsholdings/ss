...
//Document
$array_url_instruction['main'] = 'https://wiki.tms.vn/nukeviet4:admin:database';
$array_url_instruction['file'] = 'https://wiki.tms.vn/nukeviet4:admin:database:file';
$array_url_instruction['setting'] = 'https://wiki.tms.vn/nukeviet4:admin:database:setting';
$array_url_instruction['sampledata'] = 'https://wiki.tms.vn/nukeviet4:admin:database:sampledata';
