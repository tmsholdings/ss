...
//Document
$array_url_instruction['main'] = 'https://wiki.tms.vn/nukeviet4:admin:upload';
$array_url_instruction['thumbconfig'] = 'https://wiki.tms.vn/nukeviet4:admin:upload:thumbconfig';
$array_url_instruction['config'] = 'https://wiki.tms.vn/nukeviet4:admin:upload:config';
$array_url_instruction['uploadconfig'] = 'https://wiki.tms.vn/nukeviet4:admin:upload:uploadconfig';
