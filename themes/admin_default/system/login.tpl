...
<form class="loginform form-horizontal" method="post" action="{NV_BASE_ADMINURL}index.php" data-toggle="preForm">
    ...
    <div class="form-detail">
        <div class="form-group">
            ...
            <div ><input autocomplete="off" class="form-control" placeholder="{GLANG.username}"name="nv_login" type="text" id="nv_login" value="{V_LOGIN}" data-error-mess="{GLANG.username_empty}" /></div>
        </div>
        <div class="form-group">
            
            <div ><input autocomplete="off" class="form-control" placeholder="{GLANG.password}"name="nv_password" type="password" id="nv_password" value="{V_PASSWORD}" data-error-mess="{GLANG.password_empty}" /></div>
        </div>
        <!-- BEGIN: captcha -->
        <div class="form-group">
