    ...
    <div class="table-responsive">
        <table class="table table-striped table-bordered table-hover">
            ...
            <tbody>
                <tr>
                    <td colspan="2">
                        {LANG.use_setup_elasticseach}: <a href="http://wiki.tms.vn/web_server:install-and-configure-elasticsearch-on-centos-7" target="_blank">http://wiki.tms.vn/web_server:install-and-configure-elasticsearch-on-centos-7</a><br />
                        {LANG.use_dev_elasticseach}: <a href="http://wiki.tms.vn/web_server:use-elasticsearch-in-nukeviet" target="_blank">http://wiki.tms.vn/web_server:use-elasticsearch-in-nukeviet</a><br />
                    </td>
                </tr>
                <tr>
