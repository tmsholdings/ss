...
$lang_module['required_phpexcel'] = 'Pour utiliser ce fonctionnement, vous devez installer le bibliothèque PHPExcel, vous pouvez le télécharger au <a title="Download PHPExcel" href="http://tms.vn/vi/store/other/phpexcel/">NukeViet Store</a>';
...
$lang_module['cas_config_hostname_info'] = 'Hostname du serveur CAS	<br />eg: cas.tms.vn';
$lang_module['cas_config_baseUri'] = 'Base d\'URI';
$lang_module['cas_config_baseUri_info'] = 'URI of the server (nothing if no baseUri)<br />For example, if the CAS server responds to cas.tms.vn/cas/ then<br />cas_baseuri = cas/';
...
$lang_module['ldap_config_hostURL_info'] = 'Trouver de la machine centrale LDAP dans la formule d\'URL dont \'ldap://ldap.tms.vn/\' où \'ldaps://ldap.tms.vn/\'.';
