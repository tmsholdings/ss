...
//Document
$array_url_instruction['main'] = 'https://wiki.tms.vn/nukeviet4:admin:comment';
$array_url_instruction['config'] = 'https://wiki.tms.vn/nukeviet4:admin:comment#config';
$array_url_instruction['edit'] = 'https://wiki.tms.vn/nukeviet4:admin:comment#edit';
