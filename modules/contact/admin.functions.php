...
//Tài liệu hướng dẫn
$array_url_instruction['main'] = 'https://wiki.tms.vn/nukeviet4:admin:contact';
$array_url_instruction['config'] = 'https://wiki.tms.vn/nukeviet4:admin:contact#cấu_hinh_module';
$array_url_instruction['supporter'] = 'https://wiki.tms.vn/nukeviet4:admin:contact#hiển_thị_danh_sach_cac_nhan_vien_hỗ_trợ';
$array_url_instruction['department'] = 'https://wiki.tms.vn/nukeviet4:admin:contact#quản_ly_cac_bộ_phận';
$array_url_instruction['send'] = 'https://wiki.tms.vn/nukeviet4:admin:contact#gửi_phản_hồi';
$array_url_instruction['supporter-content'] = 'https://wiki.tms.vn/nukeviet4:admin:contact#them_nhan_vien_hỗ_trợ';
$array_url_instruction['row'] = 'https://wiki.tms.vn/nukeviet4:admin:contact#them_bộ_phận';
