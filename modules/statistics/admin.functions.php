...
//Document
$array_url_instruction['main'] = 'https://wiki.tms.vn/nukeviet4:admin:statistics';
$array_url_instruction['allbots'] = 'https://wiki.tms.vn/nukeviet4:admin:statistics:allbots';
$array_url_instruction['allbrowsers'] = 'https://wiki.tms.vn/nukeviet4:admin:statistics:allbrowsers';
$array_url_instruction['allcountries'] = 'https://wiki.tms.vn/nukeviet4:admin:statistics:allcountries';
$array_url_instruction['allos'] = 'https://wiki.tms.vn/nukeviet4:admin:statistics:allos';
$array_url_instruction['allreferers'] = 'https://wiki.tms.vn/nukeviet4:admin:statistics:allreferers';
