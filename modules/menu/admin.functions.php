...
//Document
$array_url_instruction['main'] = 'https://wiki.tms.vn/nukeviet4:admin:menu';
$array_url_instruction['menu'] = 'https://wiki.tms.vn/nukeviet4:admin:menu#lấy_menu_tự_dộng_từ_ten_cac_chuyen_mục_module';
$array_url_instruction['rows'] = 'https://wiki.tms.vn/nukeviet4:admin:menu#xem_sửa_khối';
