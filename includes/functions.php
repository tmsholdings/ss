 ...
 *                    reply_address: 'reply@tms.vn'(string|array),
 *                    from_name: contact@tms.vn (string),
 *                    from_address: 'NukeViet']
 *
 * $to:               address1@tms.vn
 *                    Hoặc: [address1@tms.vn,address2@tms.vn]
 *
 ...
 *
 * $cc:               contact@tms.vn
 *                    Hoặc: contact@tms.vn => NukeViet1, contact2@tms.vn => NukeViet2
 *                    Hoặc: contact@tms.vn,contact2@tms.vn
 *
 * $bcc:              contact@tms.vn
 *                    Hoặc: contact@tms.vn => NukeViet1, contact2@tms.vn => NukeViet2
 *                    Hoặc: contact@tms.vn,contact2@tms.vn
