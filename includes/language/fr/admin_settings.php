...
$lang_module['searchEngineUniqueID_note'] = 'Forma 000329275761967753447:sr7yxqgv294 , <a href="http://tms.vn/vi/faq/Su-dung-Google-Custom-Search-tren-NukeViet/" target="_blank">voir détails</a>';
...
$lang_module['rp_desc2'] = 'Types d\'informations sur le référent (peuvent être envoyées via l\'en-tête Referer):<ul><li>Origin: inclut le scheme (ex: http, https), host (ex: tms.vn) et le port (ex: 80, 443)</li><li>Path (chemin absolu sur le serveur, ex: thumuc1/index.php)</li><li>Querystring (ex: ?name=ferret&color=purple)</li></ul>';
